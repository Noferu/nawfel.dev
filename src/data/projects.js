export const projects = [
...

  {
    ...
    shortDesc: 'Outil de gestion de projet collaboratif (Scrum + Kanban) avec drag & drop natif, notifications, politiques d\'accès et design system complet.',
    longDesc:  'Projet individuel complet développé dans le cadre de la SAE 501 (BUT MMI 3). Yasuragi est une alternative légère à Trello/Jira combinant Scrum (sprints, backlog, roadmap) et Kanban. L\'application comprend un système de rôles (Owner, Manager, Member, Viewer), un board Kanban avec drag & drop HTML5 natif et mise à jour optimiste via AJAX, une roadmap timeline, un moteur de recherche global, un système de notifications in-app, et un design system complet avec support light/dark mode.',
    context:   'Projet académique individuel — SAE 501, BUT MMI 3',
    role:      'Développement full-stack complet',
...

  {
    ...
    shortDesc: 'Application mobile cross-platform pour un festival de cinéma : authentification, cartographie Mapbox, vote QR, achat de pass et notifications push.',
    longDesc:  'Projet académique de développement mobile réalisé en groupe de 3 pour le Festival Européen du Film Fantastique de Strasbourg. L\'application Flutter/Firebase couvre l\'ensemble du parcours festivalier : consultation de la programmation avec streams Firestore temps réel, système de vote via QR code, achat de pass en 3 étapes avec paiement, réservation d\'événements avec export calendrier natif, préférences personnalisées avec carte Mapbox interactive, et notifications push via Firebase Cloud Messaging. Score pédagogique estimé 22/22.',
...

  {
    ...
    shortDesc: 'Site one-page interactif sur la sobriété énergétique numérique avec visualisations de données et animations immersives.',
    longDesc:  'Projet collectif réalisé dans le cadre de la SAE 303 (équipe de 5). LUMA est un site de sensibilisation à l\'impact énergétique des loisirs numériques. Il combine des visualisations de données dynamiques via Chart.js, des animations CSS immersives, des effets sonores interactifs et des vidéos motion design pour transmettre un message engagé. Chaque membre de l\'équipe a réalisé ses propres graphiques JavaScript intégrés dans une page cohérente.',
