    ...
    <div className="cmdk-overlay" onClick={onClose}>
      <div className="cmdk-panel" onClick={e => e.stopPropagation()}>
        ...
        <div className="cmdk-footer">
          <span className="cmdk-footer-hint"><kbd className="cmdk-kbd">↑↓</kbd> naviguer</span>
          <span className="cmdk-footer-hint"><kbd className="cmdk-kbd">↵</kbd> ouvrir</span>
          <span className="cmdk-footer-hint"><kbd className="cmdk-kbd">Esc</kbd> fermer</span>
        </div>
      </div>
    </div>
  )
