 ...
 * - masque circulaire destination-out aux intersections
 * - soft lights animées en float + parallaxe GSAP
 *
 * data-intro="bg" exposé pour usePageIntro (animation d'entrée).
 */
...
export default function Background() {
  ...
  return (
    /* data-intro="bg" → ciblé par usePageIntro pour le fade-in initial */
